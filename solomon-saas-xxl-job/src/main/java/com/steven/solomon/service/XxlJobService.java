...
@Import(SaasXxlJobProperties.class)
public class XxlJobService implements SaasJobService<XxlJobInfo,XxlJobProperties>{

    @Override
    public String login(XxlJobProperties profile) throws Exception {
        String adminAddresses = getUrl(profile);
    ...
    @Override
    public void saveJob(String cookie, XxlJobInfo job, XxlJobProperties profile) throws Exception {
        String adminAddresses = getUrl(profile);
        if(ValidateUtils.isEmpty(adminAddresses)){
            throw new BaseException(XxlJobErrorCode.XXL_JOB_ADMIN_URL_IS_NULL);
        }
        cookie = ValidateUtils.getOrDefault(cookie, login(profile));

        List<XxlJobInfo> xxlJobInfoList = findByExecutorHandler(cookie,job.getExecutorHandler(),profile);
    ...
    @Override
    public void updateJob(String cookie, XxlJobInfo job, XxlJobProperties profile) throws Exception {
        String adminAddresses = getUrl(profile);
        if(ValidateUtils.isEmpty(adminAddresses)){
            throw new BaseException(XxlJobErrorCode.XXL_JOB_ADMIN_URL_IS_NULL);
        }
    ...
    @Override
    public void deleteJob(String cookie, String executorHandler, XxlJobProperties profile) throws Exception {
        String adminAddresses = getUrl(profile);
        if(ValidateUtils.isEmpty(adminAddresses)){
            throw new BaseException(XxlJobErrorCode.XXL_JOB_ADMIN_URL_IS_NULL);
        }
        ...
        List<XxlJobInfo> xxlJobInfoList = findByExecutorHandler(cookie,executorHandler,profile);
        Map<String,XxlJobInfo> xxlJobInfoMap = Lambda.toMap(xxlJobInfoList, XxlJobInfo::getExecutorHandler);
    ...
    @Override
    public void startJob(String cookie, String executorHandler, XxlJobProperties profile) throws Exception {
        String adminAddresses = getUrl(profile);
        if(ValidateUtils.isEmpty(adminAddresses)){
            throw new BaseException(XxlJobErrorCode.XXL_JOB_ADMIN_URL_IS_NULL);
        }
    ...
    @Override
    public void stopJob(String cookie, String executorHandler, XxlJobProperties profile) throws Exception {
        String adminAddresses = getUrl(profile);
        if(ValidateUtils.isEmpty(adminAddresses)){
            throw new BaseException(XxlJobErrorCode.XXL_JOB_ADMIN_URL_IS_NULL);
        }
    ...
    public List<XxlJobInfo> findByExecutorHandler(String cookie, String executorHandler,XxlJobProperties profile) throws Exception {
        String adminAddresses = getUrl(profile);
        if(ValidateUtils.isEmpty(adminAddresses)){
            throw new BaseException(XxlJobErrorCode.XXL_JOB_ADMIN_URL_IS_NULL);
        }
    ...
    private String getUrl(XxlJobProperties profile){
