...
import com.steven.solomon.persistence.aspect.DataSourceTenantAspect;
...
import com.steven.solomon.persistence.manager.DataSourceTenantManager;
...
import com.steven.solomon.persistence.routing.DynamicRoutingDataSource;
import com.steven.solomon.persistence.sql.SqlExecutor;
import com.steven.solomon.persistence.sql.converter.SqlTypeConverterCustomizer;
import com.steven.solomon.persistence.sql.converter.SqlTypeConverterRegistry;
import com.steven.solomon.persistence.sql.script.SqlScriptExecutor;
...
public class PersistenceAutoConfiguration {
  ...
  public DataSource dataSource(
      PersistenceProperties properties,
      DynamicDataSourceFactory factory,
      DataSourceTenantContext context) throws PersistenceException {
    ...
    for (Map.Entry<String, TenantDataSourceProperties> tenantEntry : properties.getTenants().entrySet()) {
      ...
      try {
        ...
        throw new PersistenceException(PersistenceErrorCode.DATA_SOURCE_INIT_FAILED, e, tenantCode);
      }
    }
