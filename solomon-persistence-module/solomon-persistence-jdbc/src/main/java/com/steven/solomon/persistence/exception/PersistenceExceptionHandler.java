 ...
 * 动态数据源异常处理器�?
 *
 * <p>数据源模块会抛出 {@link PersistenceException}，该异常已经携带业务错误码和明确消息�?
 * 这里复用基类响应构建方法，避免重复创建异常响应对象�?/p>
 */
@Configuration(proxyBeanMethods = false, value = "PersistenceExceptionProcessor")
public class PersistenceExceptionHandler extends AbstractExceptionHandler {
