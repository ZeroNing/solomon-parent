 ...
 */
public class LambdaPageParam<TModel> extends DataSourcePageParam {
  ...
  public LambdaPageParam<TModel> asc(SFunction<TModel, ?> column) throws DataSourceException {
    return sort(column, OrderByEnum.ASC);
  }

  public LambdaPageParam<TModel> desc(SFunction<TModel, ?> column) throws DataSourceException {
