...
public final class SqlTypeConverter {
   ...
   * @throws PersistenceException 转换失败时抛出国际化异常
   */
  @SuppressWarnings({"unchecked", "rawtypes"})
  public static <T> T convertForJava(Object value, Class<T> targetType) throws PersistenceException {
    ...
    try {
      ...
      throw new PersistenceException(PersistenceErrorCode.DATA_SOURCE_TYPE_CONVERT_FAILED, e,
          value.getClass().getName(), targetType.getName(), String.valueOf(value));
    }
    throw new PersistenceException(PersistenceErrorCode.DATA_SOURCE_TYPE_CONVERT_FAILED,
        value.getClass().getName(), targetType.getName(), String.valueOf(value));
  }
