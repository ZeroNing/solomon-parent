 ...
 * 数据库类型枚举�?
 *
 * <p>枚举同时维护 JDBC 驱动、Druid 防火�?dbType、默认校�?SQL �?JDBC URL 识别前缀�?
...
public enum DataBaseTypeEnum {
   ...
   * 例如 TiDB/OceanBase MySQL 模式，会优先识别为更通用�?MYSQL，业务可通过配置显式指定�?/p>
   */
