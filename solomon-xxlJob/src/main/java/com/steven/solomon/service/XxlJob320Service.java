...
public class XxlJob320Service extends CommonXxlJobService{

    protected XxlJob320Service(XxlJobProperties profile, ApplicationContext applicationContext) {
        super(profile, applicationContext);
    }

    @Override
    protected String getLoginUrl() {
        return adminAddresses + "auth/doLogin";
    }
}
