 ...
 * GS1 译码、EPC 编码生成和 EPC 反译演示。
 * </p>
 * <p>该类是带 {@code main} 方法的可运行示例，不是 JUnit 测试，故保留在 main 源码下。</p>
 *
 * @author 创建者
 */
public class EpcCoderDemo {

  /** 日志记录器。 */
  private static final Logger LOGGER = LoggerUtils.logger(EpcCoderDemo.class);
