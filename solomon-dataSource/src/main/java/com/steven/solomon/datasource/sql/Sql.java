...
public class Sql {
  ...
  private static class JoinSegment {
    ...
    private JoinSegment(JoinType joinType, String table, String alias) {
      this.joinType = joinType;
      this.table = table;
      this.alias = alias;
    }

    private JoinSegment copy() {
  ...
  private record RenderedSql(String text, Map<String, Object> params) {
  }
}
